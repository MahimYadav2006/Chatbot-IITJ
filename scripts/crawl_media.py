#!/usr/bin/env python3
"""
Crawl Media-related websites for IIT Jammu.
...
MEDIA_URLS = {
    "donations": "https://iitjammu.ac.in/donations",
    "prism": "https://iitjammu.ac.in/prism",
    "newsdigest": "https://iitjammu.ac.in/newsdigest",
    "events": "https://iitjammu.ac.in/events",
    "holidays-list-2026": "https://iitjammu.ac.in/holidays-list-2026",
    "mou": "https://iitjammu.ac.in/mou",
    "sangam-2-0": "https://sangam-2-0-psi.vercel.app/"
}

def crawl_media_sites(clean: bool = False, max_pages: Optional[int] = None, slug_to_crawl: Optional[str] = None):
    media_root = os.path.join(get_scraped_data_root(), "Media")
    ...
    with sync_playwright() as playwright:
        ...
        for slug, base_url in MEDIA_URLS.items():
            if slug_to_crawl and slug != slug_to_crawl:
                continue
            output_dir = os.path.join(media_root, slug)
            ...
            print("\n==================================================")
            print(f"Crawling media site: {slug}")
            ...
            try:
                ...
                combined_sections = [
                    f"# IIT Jammu Media Site: {slug} – Crawled Content",
                    "",
                    f"Base URL: {base_url}",
                ]
                ...
                print(f"✗ Failed crawling media site {slug}: {e}")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="IIT Jammu Media Sites Crawler")
    ...
    parser.add_argument("--slug", type=str, default=None, help="Specific slug to crawl (e.g. prism)")
    args = parser.parse_args()

    crawl_media_sites(clean=args.clean, max_pages=args.max_pages, slug_to_crawl=args.slug)
